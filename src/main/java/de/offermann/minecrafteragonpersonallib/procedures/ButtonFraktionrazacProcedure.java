...
public class ButtonFraktionrazacProcedure extends MinecraftEragonPersonallibModElements.ModElement {
	public ButtonFraktionrazacProcedure(MinecraftEragonPersonallibModElements instance) {
		super(instance, 23);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MinecraftEragonPersonallibMod.LOGGER.warn("Failed to load dependency entity for procedure ButtonFraktionrazac!");
			return;
		}
