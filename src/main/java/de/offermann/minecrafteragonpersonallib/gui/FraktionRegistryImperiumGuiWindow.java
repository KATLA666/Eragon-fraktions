...
public class FraktionRegistryImperiumGuiWindow extends ContainerScreen<FraktionRegistryImperiumGui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 5, this.guiTop + 27, 105, 20, new StringTextComponent("Empire Soldier"), e -> {
			MinecraftEragonPersonallibMod.PACKET_HANDLER.sendToServer(new FraktionRegistryImperiumGui.ButtonPressedMessage(0, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 138, this.guiTop + 27, 50, 20, new StringTextComponent("Shade"), e -> {
			MinecraftEragonPersonallibMod.PACKET_HANDLER.sendToServer(new FraktionRegistryImperiumGui.ButtonPressedMessage(1, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 137, this.guiTop + 97, 50, 20, new StringTextComponent("Urgal"), e -> {
			MinecraftEragonPersonallibMod.PACKET_HANDLER.sendToServer(new FraktionRegistryImperiumGui.ButtonPressedMessage(2, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 5, this.guiTop + 142, 40, 20, new StringTextComponent("<<<"), e -> {
			MinecraftEragonPersonallibMod.PACKET_HANDLER.sendToServer(new FraktionRegistryImperiumGui.ButtonPressedMessage(3, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 6, this.guiTop + 97, 55, 20, new StringTextComponent("Ra'zac"), e -> {
			MinecraftEragonPersonallibMod.PACKET_HANDLER.sendToServer(new FraktionRegistryImperiumGui.ButtonPressedMessage(4, x, y, z));
