...
package de.offermann.minecrafteragonpersonallib.gui.overlay;
...
public class RageOverlay extends MinecraftEragonPersonallibModElements.ModElement {
	public RageOverlay(MinecraftEragonPersonallibModElements instance) {
		super(instance, 30);
	}
