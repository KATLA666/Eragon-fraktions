...
import de.offermann.minecrafteragonpersonallib.procedures.SpecialAbilityProcedure;
import de.offermann.minecrafteragonpersonallib.MinecraftEragonPersonallibModElements;
import de.offermann.minecrafteragonpersonallib.MinecraftEragonPersonallibMod;

@MinecraftEragonPersonallibModElements.ModElement.Tag
public class SpecialabilityKeyKeyBinding extends MinecraftEragonPersonallibModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SpecialabilityKeyKeyBinding(MinecraftEragonPersonallibModElements instance) {
		super(instance, 10);
