...
import de.katla66.minecrafteragonpersonallib.procedures.SpecialAbilityProcedure;
...
public class SpecialabilityKeyKeyBinding extends MinecraftEragonFraktionsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SpecialabilityKeyKeyBinding(MinecraftEragonFraktionsModElements instance) {
		super(instance, 10);
	...
	public void initElements() {
		keys = new KeyBinding("key.minecraft_eragon_fraktions.specialability_key", GLFW.GLFW_KEY_R, "key.categories.fraktion");
