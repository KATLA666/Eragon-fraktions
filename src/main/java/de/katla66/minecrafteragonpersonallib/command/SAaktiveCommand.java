...
import de.katla66.minecrafteragonpersonallib.procedures.SAaktiveCommandExecutedProcedure;
...
public class SAaktiveCommand extends MinecraftEragonFraktionsModElements.ModElement {
	public SAaktiveCommand(MinecraftEragonFraktionsModElements instance) {
		super(instance, 25);
