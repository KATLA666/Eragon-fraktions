...
public class SpeerItem extends MinecraftEragonFraktionsModElements.ModElement {
	@ObjectHolder("minecraft_eragon_fraktions:speer")
	public static final Item block = null;
	@ObjectHolder("minecraft_eragon_fraktions:entitybulletspeer")
	public static final EntityType arrow = null;
	public SpeerItem(MinecraftEragonFraktionsModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("minecraft_eragon_fraktions:textures/speer.png");
