...
import de.katla66.minecrafteragonpersonallib.itemgroup.EragonItemGroup;
...
public class DwarfsThrowableAxeItem extends MinecraftEragonFraktionsModElements.ModElement {
	@ObjectHolder("minecraft_eragon_fraktions:dwarfs_throwable_axe")
	public static final Item block = null;
	@ObjectHolder("minecraft_eragon_fraktions:entitybulletdwarfs_throwable_axe")
	public static final EntityType arrow = null;
	public DwarfsThrowableAxeItem(MinecraftEragonFraktionsModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("minecraft_eragon_fraktions:textures/axedieechte.png");
