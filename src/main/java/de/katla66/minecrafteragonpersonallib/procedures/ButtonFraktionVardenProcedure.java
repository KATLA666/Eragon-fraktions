...
public class ButtonFraktionVardenProcedure extends MinecraftEragonFraktionsModElements.ModElement {
	public ButtonFraktionVardenProcedure(MinecraftEragonFraktionsModElements instance) {
		super(instance, 3);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MinecraftEragonFraktionsMod.LOGGER.warn("Failed to load dependency entity for procedure ButtonFraktionVarden!");
			return;
		}
