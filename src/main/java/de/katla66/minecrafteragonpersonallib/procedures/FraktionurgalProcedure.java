...
public class FraktionurgalProcedure extends MinecraftEragonFraktionsModElements.ModElement {
	public FraktionurgalProcedure(MinecraftEragonFraktionsModElements instance) {
		super(instance, 35);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MinecraftEragonFraktionsMod.LOGGER.warn("Failed to load dependency entity for procedure Fraktionurgal!");
			return;
		}
			...
			if (((entity.getPersistentData().getDouble("active")) == 0)) {
				{
					...
					if (!_ent.world.isRemote && _ent.world.getServer() != null) {
						_ent.world.getServer().getCommandManager().handleCommand(
								...
								"attribute @s minecraft:generic.movement_speed base set 0.109");
					}
				}
				{
					Entity _ent = entity;
