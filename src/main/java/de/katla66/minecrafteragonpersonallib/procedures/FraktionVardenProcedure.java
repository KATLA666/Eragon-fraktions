...
public class FraktionVardenProcedure extends MinecraftEragonFraktionsModElements.ModElement {
	public FraktionVardenProcedure(MinecraftEragonFraktionsModElements instance) {
		super(instance, 17);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MinecraftEragonFraktionsMod.LOGGER.warn("Failed to load dependency entity for procedure FraktionVarden!");
			return;
		}
