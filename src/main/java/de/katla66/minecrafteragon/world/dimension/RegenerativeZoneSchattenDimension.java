...
import de.katla66.minecrafteragon.procedures.RegenerativeZoneSchattenPlayerEntersDimensionProcedure;
import de.katla66.minecrafteragon.item.RegenerativeZoneSchattenItem;
import de.katla66.minecrafteragon.block.PortalblockBlock;
...
public class RegenerativeZoneSchattenDimension extends MinecraftEragonFraktionsModElements.ModElement {
	@ObjectHolder("minecraft_eragon_fraktions:regenerative_zone_schatten_portal")
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("regenerative_zone_schatten_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("regenerative_zone_schatten_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("regenerative_zone_schatten_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new RegenerativeZoneSchattenItem().setRegistryName("regenerative_zone_schatten"));
	}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					...
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY,
							new ResourceLocation("minecraft_eragon_fraktions:regenerative_zone_schatten")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY,
				new ResourceLocation("minecraft_eragon_fraktions:regenerative_zone_schatten"))) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				RegenerativeZoneSchattenPlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
