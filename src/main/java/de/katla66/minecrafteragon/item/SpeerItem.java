...
import de.katla66.minecrafteragon.entity.renderer.SpeerRenderer;
...
public class SpeerItem extends MinecraftEragonFraktionsModElements.ModElement {
	...
	public SpeerItem(MinecraftEragonFraktionsModElements instance) {
		super(instance, 28);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SpeerRenderer.ModelRegisterHandler());
	}
